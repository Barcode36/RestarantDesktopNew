...
import RestarantApp.Billing.BillingModel;
...
public class NotesEditingCell extends TableCell<BillingModel, String> {
    private TextField textField;
    public NotesEditingCell() {
    }
    @Override
        ...
        textField.setOnKeyPressed(new EventHandler<KeyEvent>() {
            ...
            public void handle(KeyEvent t) {
                if (t.getCode() == KeyCode.ENTER) {
                    ...
                    billingModel.setNotes(textField.getText());
